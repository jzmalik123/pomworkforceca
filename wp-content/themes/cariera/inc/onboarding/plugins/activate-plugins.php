...
function cariera_register_required_plugins() {
	...
	$plugins = [
		[
			'name'             => 'Cariera Core',
			'slug'             => 'cariera-plugin',
			'source'           => 'https://cariera.co/plugins/BQS0WE8dsbgsMRDt/cariera-plugin.zip',
			'required'         => true,
			'version'          => '1.6.2',
		...
		[
			...
			'slug'             => 'revslider',
			'source'           => 'https://cariera.co/plugins/BQS0WE8dsbgsMRDt/revslider.zip',
			'required'         => true,
			'version'          => '6.5.25',
			'force_activation' => false,
		],
		...
		[
			...
			'source'   => 'https://cariera.co/plugins/BQS0WE8dsbgsMRDt/wp-job-manager-alerts.zip',
			'required' => false,
			'version'  => '1.5.5',
		],
		[
			...
			'source'   => 'https://cariera.co/plugins/BQS0WE8dsbgsMRDt/wp-job-manager-applications.zip',
			'required' => false,
			'version'  => '2.5.4',
		],
		[
			...
			'source'   => 'https://cariera.co/plugins/BQS0WE8dsbgsMRDt/wp-job-manager-application-deadline.zip',
			'required' => false,
			'version'  => '1.2.5',
		],
		[
			...
			'source'   => 'https://cariera.co/plugins/BQS0WE8dsbgsMRDt/wp-job-manager-bookmarks.zip',
			'required' => false,
			'version'  => '1.4.2',
		],
		[
			...
			'source'   => 'https://cariera.co/plugins/BQS0WE8dsbgsMRDt/wp-job-manager-resumes.zip',
			'required' => false,
			'version'  => '1.18.6',
		],
		[
			...
			'source'   => 'https://cariera.co/plugins/BQS0WE8dsbgsMRDt/wp-job-manager-tags.zip',
			'required' => false,
			'version'  => '1.4.2',
		],
		[
			...
			'source'   => 'https://cariera.co/plugins/BQS0WE8dsbgsMRDt/wp-job-manager-wc-paid-listings.zip',
			'required' => false,
			'version'  => '2.9.8',
		],
		[
