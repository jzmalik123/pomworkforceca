...
if ( cariera_core_is_activated() && get_option( 'cariera_company_manager_integration', false ) && function_exists( 'cariera_get_the_company' ) ) {
				...
				<ul class="meta">
					...
					if ( get_option( 'job_manager_enable_types' ) ) {
						...
						if ( ! empty( $types ) ) {
							...
							<span class="job-type <?php echo esc_attr( sanitize_title( $types[0]->slug ) ); ?>"><?php echo esc_html( $types[0]->name ); ?></span>
